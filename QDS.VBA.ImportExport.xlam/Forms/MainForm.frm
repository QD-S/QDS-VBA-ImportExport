...
On Error GoTo ErrorHandle
    ...
    Else
        If InternalUtility.HasWorkbook(Workbooks, CodeTargetNameTextBox.Text) Then
            VbaUtility.ImportFiles Workbooks(CodeTargetNameTextBox.Text)
        Else
...
On Error GoTo ErrorHandle
    ...
    Else
        If InternalUtility.HasWorkbook(Workbooks, CodeTargetNameTextBox.Text) Then
            VbaUtility.ExportFiles Workbooks(CodeTargetNameTextBox.Text)
        Else
